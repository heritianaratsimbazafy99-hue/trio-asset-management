...
export const NOTIFICATION_ROUTING_SCENARIOS = [
  ...
  },
  {
    ...
    description: "Tickets maintenance en attente de validation CEO/DAF.",
    allowedRoles: [APP_ROLES.CEO, APP_ROLES.DAF],
  },
  {
    notificationType: "WORKFLOW_PENDING",
    ...
    allowedRoles: [APP_ROLES.CEO, APP_ROLES.DAF, APP_ROLES.RESPONSABLE],
  },
  {
